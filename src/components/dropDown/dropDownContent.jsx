      ...
      <div>
         <div className="flex gap-8">
          <div className="flex flex-col gap-2 mt-3">
            ...
            <select className="w-96 h-10 px-4 border border-gray-300 rounded-md">
          ...
          <div className="flex flex-col gap-2 mt-3 flex-1">
            ...
            <select className="w-full h-10 px-4 border border-gray-300 rounded-md">
              <option value="sale">Sale</option>
              <option value="rent">
               Rent
              </option>
        ...
        <div className="mt-5 flex gap-5 ">
             ...
             <input  type="text" placeholder="House Sale" className="w-72 h-10 border border-gray-300 rounded-md px-5"/>
             </div>
             <div className="flex flex-col gap-1 ">
                <label className="text-lg font-semibold">Area</label>
                ...
                <select className="w-96 h-10 px-4 border border-gray-300 rounded-md">
                  ...
                  <option value="apartment">Layyah,phase 57 street no 11 block g</option>
                </select>
              </div>
              <div className="flex flex-col gap-1 ">
                <label className="text-lg font-semibold">Exact Location</label>

                <select className="w-80 h-10 px-4 border border-gray-300 rounded-md">
